...
public interface SearchExtendedOperations {
	 ...
	 * @return a {@link SearchResultsExtended} containing the search results metadata and a list of matching {@link Tweet}s
	 ...
	 * @see SearchResultsExtended
	 * @see Tweet
	 */
	SearchResultsExtended search(String query);
	 ...
	 * @see Tweet
	 */
	SearchResultsExtended search(String query, int pageSize);
	 ...
	 * @see Tweet
	 */
	SearchResultsExtended search(String query, int pageSize, long sinceId, long maxId);
	 ...
	 * @see Tweet
	 */
	SearchResultsExtended search(SearchParameters searchParameters);
	/**
